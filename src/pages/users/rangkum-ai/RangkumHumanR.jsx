                    ...
                    <div className="flex-1">
                        <ul className="space-y-6 relative z-20">
                            <li className="flex items-center gap-6 ml-[-30px]">
                                ...
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed ">
                                    Polis Asuransi (mobil, jiwa,<br /> kesehatan, properti)
                                </span>
                            </li>
                            <li className="flex items-center gap-6 ml-[-30px]">
                                <span className="w-2 h-2 mt-1 rounded-full bg-[#0377FF] flex-shrink-0" />
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">
                                    Formulir Klaim & Bukti<br />Kerugian
                                </span>
                            </li>
                            <li className="flex items-center gap-6 ml-[-30px]">
                                <span className="w-2 h-2 mt-1 rounded-full bg-[#0377FF] flex-shrink-0" />
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">
                                    Surat Keterangan Dokter &<br />Medis
                                </span>
                            </li>
                            <li className="flex items-center gap-6 ml-[-30px]">
                                <span className="w-2 h-2 mt-1 rounded-full bg-[#0377FF] flex-shrink-0" />
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">
                                    Kuitansi & Dokumen<br />Identitas (KTP, SIM,<br />NPWP)Invoice Medis
                                </span>
                            </li>
                            <li className="flex items-center gap-6 ml-[-30px]">
                                <span className="w-2 h-2 mt-1 rounded-full bg-[#0377FF] flex-shrink-0" />
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">
                                    Kwitansi Rumah Sakit &<br />Tagihan Medis
                                </span>
                            </li>
                        </ul>
                    </div>
