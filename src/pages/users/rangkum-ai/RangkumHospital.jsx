                    ...
                    <div className="flex-1 flex flex-col items-start justify-center px-0 md:px-6">
                        <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold font-inter mb-5 leading-[1.3] pb-[10px]">
                            <span className="bg-[#0377FF] text-transparent bg-clip-text whitespace-nowrap">
                                AI for Smarter Document<br />Processing in Healthcare
                            </span>
                        </h1>
            ...
            <section className="relative py-16 overflow-hidden px-4 md:px-12">
                ...
                <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 mb-25">
                    <div className="flex-1 flex flex-col items-start justify-center px-0 md:px-6">
                        ...
                        <p className="text-1xl md:text-3xl font-inter font-normal text-black/90 leading-relaxed max-w-lg text-left">
                            Baca data pasien, diagnosa, resep, hingga hasil pemeriksaan dari berbagai format dan tulisan tangan
                        </p>
                    </div>
                    <div className="flex-1 flex items-center justify-center px-0 md:px-6">
                        <img
                            src="/images/RangkumAi/RangkumHospital/IndustriHC2.svg"
                            alt="HR Document Management"
                ...
                <div className="flex flex-col md:flex-row-reverse relative max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 mb-25">
                    <div className="flex-1 flex flex-col items-start justify-center px-0 md:px-6">
                        ...
                        <p className="text-1xl md:text-3xl font-inter font-normal text-black/90 leading-relaxed max-w-lg text-left">
                            Ubah dokumen cetak atau hasil scan menjadi data terstruktur dan mudah dicari untuk kebutuhan administratif maupun audit.
                        </p>
                    </div>
                    <div className="flex-1 flex items-center justify-center px-0 md:px-6">
                        <img
                            src="/images/RangkumAi/RangkumHospital/IndustriHC3.svg"
                            alt="HR Document Management"
                            className="w-full max-w-md h-auto"
                        />
                    </div>
                ...
                <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 mb-25">
                    ...
                    <div className="flex-1 flex items-center justify-center px-0 md:px-6">
                        <img
                            src="/images/RangkumAi/RangkumHospital/IndustriHC4.svg"
                            alt="HR Document Management"
                            className="w-full max-w-md h-auto"
                        />
                    </div>
                ...
                <div className="flex flex-col md:flex-row-reverse relative max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10 mb-25">
                    ...
                    <div className="flex-1 flex items-center justify-center px-0 md:px-6">
                        <img
                            src="/images/RangkumAi/RangkumHospital/IndustriHC5.svg"
                            alt="HR Document Management"
                            className="w-full max-w-md h-auto"
                        />
                    </div>
                    ...
                    <div className="flex-1">
                        <ul className="space-y-6 relative z-20">
                            <li className="flex items-center gap-6 ml-[-30px]">
                                ...
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed ">Rekam Medis & Ringkasan<br />Pasien</span>
                            </li>
                            <li className="flex items-center gap-6 ml-[-30px]">
                                <span className="w-2 h-2 mt-1 rounded-full bg-[#0377FF] flex-shrink-0" />
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">Hasil Lab & Radiologi</span>
                            </li>
                            <li className="flex items-center gap-6 ml-[-30px]">
                                <span className="w-2 h-2 mt-1 rounded-full bg-[#0377FF] flex-shrink-0" />
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">Surat Rujukan & Keterangan<br />Dokter</span>
                            </li>
                            <li className="flex items-center gap-6 ml-[-30px]">
                                <span className="w-2 h-2 mt-1 rounded-full bg-[#0377FF] flex-shrink-0" />
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">Kuitansi & Invoice Medis</span>
                            </li>
                            <li className="flex items-center gap-6 ml-[-30px]">
                                <span className="w-2 h-2 mt-1 rounded-full bg-[#0377FF] flex-shrink-0" />
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">Klaim Asuransi Kesehatan</span>
                            </li>
                            <li className="flex items-center gap-6 ml-[-30px]">
                                <span className="w-2 h-2 mt-1 rounded-full bg-[#0377FF] flex-shrink-0" />
                                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">Format file: PDF, Word, JPG,<br />PNG, TIFF</span>
                            </li>
                        </ul>
                    </div>
