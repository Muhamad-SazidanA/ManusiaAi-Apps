...
export default function RangkumHospital() {
    ...
    return (
        <div className="w-full min-h-screen bg-white text-blue-800 font-inter relative overflow-x-hidden">
            ...
            <section className="min-h-screen flex items-center justify-center bg-white overflow-hidden relative px-4 md:px-12">
                <div className="relative max-w-7xl w-full mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-16 mb-16">
                    ...
                    <div className="flex-1 flex flex-col items-start justify-center md:px-6 text-left">
                        <h1 className="text-4xl md:text-5xl font-bold font-inter mb-5 leading-snug">
                    ...
                    <div className="flex-1 flex items-center justify-center md:px-6">
                        <img
                            ...
                            alt="Healthcare Document Processing"
            ...
            {/* Benefits Section */}
            <section className="relative py-16 overflow-hidden px-4 md:px-12">
                <h3 className="text-3xl md:text-5xl font-semibold text-[#0377FF] mb-16 text-center">
                    Examples of Supported Documents
                </h3>

                <div className="max-w-6xl w-full mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
                    {/* Kiri: List Dokumen */}
                    <div className="flex-1 w-full">
                        <ul className="space-y-6">
                            {[
                                "Rekam Medis & Ringkasan Pasien",
                                "Hasil Lab & Radiologi",
                                "Surat Rujukan & Keterangan Dokter",
                                "Kuitansi & Invoice Medis",
                                "Klaim Asuransi Kesehatan",
                                "Format file: PDF, Word, JPG, PNG, TIFF"
                            ].map((text, index) => (
                                <li key={index} className="flex items-start gap-4">
                                    <span className="mt-2 w-2 h-2 rounded-full bg-[#0377FF] flex-shrink-0" />
                                    <span className="text-lg md:text-2xl text-[#0377FF] leading-relaxed font-inter">
                                        {text}
                                    </span>
                                </li>
                            ))}
                    ...
                    {/* Kanan: Gambar */}
                    <div className="flex-none w-full max-w-[250px] md:max-w-[320px]">
                        <img
            ...
            <section className="relative py-24 bg-white flex flex-col items-center justify-center overflow-hidden px-4 md:px-0">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg md:text-3xl font-medium text-[#0377FF] max-w-3xl mx-auto leading-snug">
                        Temukan bagaimana Rangkum.AI bisa membantu rumah sakit dan klinik Anda bekerja lebih cepat dan efisien.                    </p>
                </div>
