...
export default function BrilianInsurance() {
  ...
  return (
    <div className="w-full min-h-screen bg-white text-blue-800 font-inter relative overflow-x-hidden">
      ...
      <section className="min-h-screen flex items-center justify-center bg-white overflow-hidden relative px-4 md:px-0">
        <div className="relative max-w-6xl w-full mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10 py-10 md:py-0">
          ...
          <div className="flex-1 flex flex-col items-center md:items-start justify-center text-center md:text-left px-0 md:px-6">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-bold font-inter mb-5 leading-snug">
              <span className="bg-[#0377FF] text-transparent bg-clip-text">
                Empower Your Insurance<br className="hidden sm:block" />
                Operations with Smart<br className="hidden sm:block" />
                Knowledge Access
              </span>
            </h1>
            <p className="text-sm sm:text-base md:text-2xl text-[#0377FF] mb-8 font-light max-w-md">
              Tingkatkan Kecepatan dan Ketepatan Layanan Asuransi
            </p>
            <Link
          ...
          <div className="flex-1 flex items-center justify-center px-0 md:px-6">
            <img
              src="/images/BrilianAi/BrilianInsurance/BrilianInsurance1.svg"
      ...
      {/* Benefits Section */}
      <section className="relative py-16 overflow-hidden px-4 md:px-0">
        <h3 className="relative z-20 text-4xl md:text-5xl font-semibold text-[#0377FF] mb-20 text-center"> Benefits for Insurance<br />Companies</h3>
          ...
          <div className="flex-1">
            <ul className="space-y-6 relative z-20">
              <li className="flex items-center gap-6 ml-[-30px]">
                ...
                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed ">Percepat waktu respon klaim<br />& underwriting</span>
              </li>
              <li className="flex items-center gap-6 ml-[-30px]">
                <span className="w-8 h-8 mt-1 rounded-full bg-gradient-to-b from-[#97BDFD] to-[#1A62DC] flex-shrink-0" />
                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">Pengambilan keputusan<br />lebih cepat & berbasis data</span>
              </li>
              <li className="flex items-center gap-6 ml-[-30px]">
                <span className="w-8 h-8 mt-1 rounded-full bg-gradient-to-b from-[#97BDFD] to-[#1A62DC] flex-shrink-0" />
                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">Kurangi kesalahan akibat<br /> misinterpretasi dokumen</span>
              </li>
              <li className="flex items-center gap-6 ml-[-30px]">
                <span className="w-8 h-8 mt-1 rounded-full bg-gradient-to-b from-[#97BDFD] to-[#1A62DC] flex-shrink-0" />
                <span className="text-1xl md:text-3xl font-inter font-normal text-[#0377FF] leading-relaxed">Tingkatkan produktivitas &<br />kepuasan nasabah</span>
              </li>
            </ul>
          </div>
