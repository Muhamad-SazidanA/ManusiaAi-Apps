...
Mohon ditindaklanjuti. Terima kasih.
            ...
            const whatsappNumber = '628973923000'; // Ganti ke nomor tujuan
                ...
                <div className="w-full max-w-xl mx-auto my-12">
                    <div className="bg-white rounded-2xl shadow-[0_0_0_2px_rgba(3,119,255,0.10)] border border-blue-100 p-8 md:p-10">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-8">
                                <label className="block text-sm font-semibold text-[#0377FF] mb-2">Message</label>
                                <textarea
                                    name="message"
                                    rows="4"
                                    value={form.message}
