        ...
        <div className="relative z-10 w-full flex flex-col items-start md:items-start justify-center h-[500px] px-4 md:px-8 lg:px-16 pt-10 md:pt-0">
          ...
          <div className="w-full flex justify-center md:justify-start">
            <Link onClick={() => handleNavigation('/demo-email')}
              className="flex justify-center items-center h-10 px-10 text-white bg-blue-600/20 border border-blue-500/30 rounded-md hover:bg-blue-600/30 hover:border-blue-500/60 hover:shadow-md hover:scale-105 transition-all duration-200 ease-in-out cursor-pointer font-inter font-semibold">
              Start For Free
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex justify-center mb-14">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-4xl">
              <button
                className={`
            w-full px-6 py-3 font-bold font-inter text-lg md:text-xl
          ...
          `}
              ...
              <button
                className={`
            w-full px-6 py-3 font-bold font-inter text-lg md:text-xl flex flex-col items-center justify-center
            rounded-[12px] border transition-all duration-200
            ${activeTab === "advin"
